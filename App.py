...
import pymysql
from Subjects import data_course,web_course,android_course,ios_course,uiux_course,resume_videos,interview_videos
import pafy 
            ...
            if resume_data:
                ...
                for i in resume_data['skills']:
                    ...
                    if i.lower() in ds_keyword:
                        ...
                        rec_course = course_recommender(data_course)
                        break
